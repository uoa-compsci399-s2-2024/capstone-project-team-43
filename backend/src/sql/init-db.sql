CREATE TABLE PROJECT (
    ...
    other_client_details VARCHAR(4096),
    deliverable VARCHAR(4096),
    description VARCHAR(4096) NOT NULL,
    owner_id INTEGER NOT NULL,
    preferred_skills VARCHAR(4096),
    special_requirements VARCHAR(4096),
    available_resources VARCHAR(4096),
