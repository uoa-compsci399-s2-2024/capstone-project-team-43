                            ...
                            <div className='pop-up'>
                                ...
                                <div className='pop-up-text'>
                                    <p className='warning'>WARNING: Deleting your account will delete any project proposals you have submitted, 
                                        which will prevent them being assigned to student teams.
                                        <br></br> This cannot be undone.</p>
                                </div>
                                <button className='pop-up-button confirm-delete-account-button' onClick={handleDeleteAccount}>Confirm Account Deletion</button>
                            </div>                
                        )}
                        </div>
                </div>
